...
| 7 | SIGTERM guard redeploy sweep — 12 named Cloud Run job resources still running pre-fix images (root cause already fixed and live on main) | hauska-factory (GCP deploy only) | Yes |
