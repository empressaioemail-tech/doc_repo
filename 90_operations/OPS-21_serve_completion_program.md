...
| 3P-17 | **Stale prose figure in `zoning-layer-completeness.mjs`** — Elgin "1,680 held" against the file's own later, binding 506 ceiling. Found by Z1 | Cosmetic today; the binding number is the one the code uses | **The next lane that edits that file for any reason** | property |
