...
- **Agent door:** the programmatic agent interface IS live and is a shipping feature. The Smart Site connector serves at `mcp.smartsite.cloud`, and the 2026-08-31 ruling makes it a door rather than a tier: available at every rung including Free, mirroring the workbench gates rather than carrying its own. Same records, same citations. *(Corrected 2026-09-02; this previously read "not commercially live; speak of it at architecture altitude," which P-87 superseded when the connector shipped.)*
