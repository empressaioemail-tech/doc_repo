...
5. **Cut consumers to the gate.** Each app consumes engine reasoning through the gate seam; lock cortex-api's direct engine routes. Depends on step 4 + the tenant-leg gate work ([`54`](54_tenant_leg_sprint.md)) + **the gate-citation-lineage closure** ([`_dispatches/2026-06-09_cc-agent-M_gate_citation_lineage.md`](_dispatches/2026-06-09_cc-agent-M_gate_citation_lineage.md)): until the gate threads finding citations on fetch (P0a) and preserves them on override (P2), routing adjudication through the gate makes the arrow-two deposit loop go silent (the gate is arrow-one-only for the Codex finding path per the 2026-06-09 lineage audit). This is a hard gate on step 5, not advisory.
