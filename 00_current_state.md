...
- **cc-agent-C** → legacy-design-tools — Codex Phase 2 reviewer surfaces delivered (CDX-3/4/5, PRs #69/#70/#71 merged). Lane C.4 confirmed already shipped (#46/#51, 2026-05-20); its dispatch marked COMPLETE. Dispatched on **CDX-9** (Codex comment-letter auto-draft) per [`_dispatches/2026-05-22_cc-agent-C_cdx9_comment_letter.md`](_dispatches/2026-05-22_cc-agent-C_cdx9_comment_letter.md); the DA-5 gate was verified shipped against the live repo.
...
- **Teed-up cc-agent dispatch queue** (2026-05-21, updated 2026-05-22). cc-agent-C: Codex Phase 2 reviewer surfaces delivered (CDX-3/4/5, #69/#70/#71); Lane C.4 confirmed already shipped (#46/#51, 2026-05-20), its dispatch [`_dispatches/2026-05-19_cc-agent-C_l_surface_ui.md`](_dispatches/2026-05-19_cc-agent-C_l_surface_ui.md) marked COMPLETE. Now dispatched on **CDX-9** (Codex comment-letter auto-draft, [`_dispatches/2026-05-22_cc-agent-C_cdx9_comment_letter.md`](_dispatches/2026-05-22_cc-agent-C_cdx9_comment_letter.md)); DA-5 gate verified shipped. Still open from Lane C.4 close: the DA-MCP-Cortex Group 4 cross-client verification (appears largely done per hauska-mcp-server #12/#21, needs a confirmation pass) and legacy task #29 dual-auth tightening (non-blocking). cc-agent-AC: QA-17 (#64), api-server import migration (#65), and the `@workspace/empressa-atom` retirement (#67) all merged; dispatch queue empty, no current dispatch. QUEUED, not yet fireable: ECI atomization P1 ([`_dispatches/2026-05-21_eci_atomization_p1_registry_scaffold_QUEUED.md`](_dispatches/2026-05-21_eci_atomization_p1_registry_scaffold_QUEUED.md)) — gated on Nick creating the `empressa-atom-internal` repo and a cc-agent seat freeing. QA-20 routed into cc-agent-E Lane E Phase E1.
