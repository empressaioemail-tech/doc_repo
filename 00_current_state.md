...
- **cc-agent-C** → legacy-design-tools — Cortex QA close-out + QA-22 Part 1 + codex-reviewer-qa scaffold + cleanup batch all merged (PRs #59-63, #66, #68). Codex Phase 2 in progress: CDX-3 (#69) and CDX-4 (#70) merged; CDX-5 next — the last stream, ruled an engagement switcher, ready to fire. cc-agent-C idle at the CDX-4 break-point.
...
- **Teed-up cc-agent dispatch queue** (2026-05-21, updated 2026-05-22). cc-agent-C: Codex Phase 2 CDX-3 (#69) and CDX-4 (#70) merged; **CDX-5** — the last stream of [`_dispatches/2026-05-21_cc-agent-C_codex_phase2_reviewer_surfaces.md`](_dispatches/2026-05-21_cc-agent-C_codex_phase2_reviewer_surfaces.md), ruled an engagement/submission switcher in the dispatch's "Planner ruling 2026-05-21" block — is ready to fire. cc-agent-C is idle at the CDX-4 break-point; the re-poke must point it at the CDX-5 ruling (its CDX-4 report still believed CDX-5 unruled). cc-agent-AC: QA-17 (#64), api-server import migration (#65), and the `@workspace/empressa-atom` retirement (#67) all merged; dispatch queue empty, no current dispatch. QUEUED, not yet fireable: ECI atomization P1 ([`_dispatches/2026-05-21_eci_atomization_p1_registry_scaffold_QUEUED.md`](_dispatches/2026-05-21_eci_atomization_p1_registry_scaffold_QUEUED.md)) — gated on Nick creating the `empressa-atom-internal` repo and a cc-agent seat freeing. QA-20 routed into cc-agent-E Lane E Phase E1.
