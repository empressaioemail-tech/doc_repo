...
- **Cortex QA close-out + QA-22** — cc-agent-C, legacy-design-tools. Close-out complete (QA-16/23/19/18 = PRs #59-62), **QA-22 Part 1 merged** (PR #63 — site-context adapter-timeout reliability), and **codex-reviewer-qa scaffold merged** (PR #66 — see M-CodexQA below). cc-agent-C is now dispatched on the legacy-design-tools cleanup batch (QA-15, QA-26, flaky `lib/codes` CI), then Codex Phase 2 reviewer surfaces. QA-16 does not close QA-04 — see watch list.
...
- **cc-agent-C** → legacy-design-tools — Cortex QA close-out + QA-22 Part 1 + codex-reviewer-qa scaffold all merged (PRs #59-63, #66). Dispatched: legacy-design-tools cleanup batch (QA-15, QA-26, flaky `lib/codes` CI), then Codex Phase 2 reviewer surfaces (CDX-3/4/5).
...
- **Teed-up cc-agent dispatch queue** (2026-05-21). cc-agent-C: close-out + QA-22 + codex-reviewer-qa scaffold all merged (PRs #59-63, #66); dispatched on a two-step queue — the legacy-design-tools cleanup batch ([`_dispatches/2026-05-21_cc-agent-C_ldt_cleanup_batch.md`](_dispatches/2026-05-21_cc-agent-C_ldt_cleanup_batch.md)) then Codex Phase 2 reviewer surfaces ([`_dispatches/2026-05-21_cc-agent-C_codex_phase2_reviewer_surfaces.md`](_dispatches/2026-05-21_cc-agent-C_codex_phase2_reviewer_surfaces.md)). cc-agent-AC: QA-17 (#64) and api-server import migration (#65) merged; the `@workspace/empressa-atom` retirement is done — PR #67 open, CI green, awaiting merge. cc-agent-AC's dispatch queue is empty once #67 merges. QUEUED, not yet fireable: ECI atomization P1 ([`_dispatches/2026-05-21_eci_atomization_p1_registry_scaffold_QUEUED.md`](_dispatches/2026-05-21_eci_atomization_p1_registry_scaffold_QUEUED.md)) — gated on Nick creating the `empressa-atom-internal` repo and a cc-agent seat freeing. QA-20 routed into cc-agent-E Lane E Phase E1.
