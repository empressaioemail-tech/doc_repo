...
- **cc-agent-C** → legacy-design-tools — Codex Phase 2 reviewer-surfaces dispatch delivered in full (CDX-3 #69, CDX-4 #70 merged; CDX-5 #71 open). Next: **Lane C.4** (L1-L6 endpoints + UI runtime layer) per the re-activated dispatch [`_dispatches/2026-05-19_cc-agent-C_l_surface_ui.md`](_dispatches/2026-05-19_cc-agent-C_l_surface_ui.md) — gates all cleared in the 2026-05-22 activation update.
...
- **Teed-up cc-agent dispatch queue** (2026-05-21, updated 2026-05-22). cc-agent-C: Codex Phase 2 reviewer surfaces delivered (CDX-3 #69, CDX-4 #70 merged, CDX-5 #71 open). Next is **Lane C.4** — the L1-L6 endpoints + UI runtime layer in legacy-design-tools (DA-4/5/6 plus the full L-surface). The dispatch already exists ([`_dispatches/2026-05-19_cc-agent-C_l_surface_ui.md`](_dispatches/2026-05-19_cc-agent-C_l_surface_ui.md)) and was re-activated 2026-05-22: gates all satisfied (Lane C.3 EngagementDetail split merged #43; L1-L6 atom shapes locked at `@hauska-engine/atoms@0.6.0`; Lane B MCP tools shipped). Ready to fire. Lane C.4 close unblocks DA-MCP-Cortex Group 4 verification and Codex CDX-9. cc-agent-AC: QA-17 (#64), api-server import migration (#65), and the `@workspace/empressa-atom` retirement (#67) all merged; dispatch queue empty, no current dispatch. QUEUED, not yet fireable: ECI atomization P1 ([`_dispatches/2026-05-21_eci_atomization_p1_registry_scaffold_QUEUED.md`](_dispatches/2026-05-21_eci_atomization_p1_registry_scaffold_QUEUED.md)) — gated on Nick creating the `empressa-atom-internal` repo and a cc-agent seat freeing. QA-20 routed into cc-agent-E Lane E Phase E1.
