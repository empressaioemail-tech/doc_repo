...
| [`C1_cortex_cut_to_gate`](_dispatches/2026-06-10_cc-agent-C_C1_cortex_cut_to_gate.md) | legacy-design-tools | cc-agent-C | C1 | **FIRE-READY** after the merge queue is current (the big cut: Cortex→gate + S1 precedence wire + provenance envelope) |
