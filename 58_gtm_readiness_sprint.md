...
| [`texas_coverage_gap_analysis`](_dispatches/2026-06-10_cc-agent-C_texas_coverage_gap_analysis.md) | legacy-design-tools | cc-agent-C | B2 | FIRE-READY (now has real seed data; must size the verified-vs-unverified split + driver-quality fill) |
