...
| [`cortex_intake_chat_wedge_fixes`](_dispatches/2026-06-10_cc-agent-C_cortex_intake_chat_wedge_fixes.md) | legacy-design-tools | cc-agent-C | wedge polish | **RUNNING** (pre-Revit chat + multi-attach + image vision; dogfooding found the live wedge is blocked) |
| [`cortex_artifact_ux`](_dispatches/2026-06-10_cc-agent-C_cortex_artifact_ux.md) | legacy-design-tools | cc-agent-C | wedge polish | **FIRE-READY — HIGH** (auto-nav to artifact + letter document view/scroll + download/print; dogfooding the live deliverable letter) |
...
| [`texas_statewide_jurisdiction_gap`](_dispatches/2026-06-10_cc-agent-C2_texas_statewide_jurisdiction_gap.md) | legacy-design-tools (xrepo) | cc-agent-C2 | post-launch (warm-up) | FIRE-READY as recon (enumerate+tier TX jurisdictions; **demand-driven, NOT flat-batch**; San Marcos = priority-1 fill). Decision [`_decisions/2026-06-10_texas_coverage_demand_driven.md`](_decisions/2026-06-10_texas_coverage_demand_driven.md) |
