...
| [`cortex_artifact_ux`](_dispatches/2026-06-10_cc-agent-C_cortex_artifact_ux.md) | legacy-design-tools | cc-agent-C | wedge polish | **RUNNING** (auto-nav to artifact + letter document view/scroll + download/print; dogfooding the live deliverable letter) |
