...
| [`cortex_per_user_auth`](_dispatches/2026-06-10_cc-agent-C_cortex_per_user_auth.md) | legacy-design-tools | cc-agent-C | task #29 | FIRE-READY — **WIDENED: one identity across Cortex web + extension** (cut-independent; extension sign-in executes in C2) |
| [`permit_ahj_connector_recon`](_dispatches/2026-06-10_cc-agent-C2_permit_ahj_connector_recon.md) | legacy-design-tools (xrepo) | cc-agent-C2 | post-launch / C4 | FIRE-READY as recon (parallel-safe; cost-envelope kill gate; build is post-launch) |
