...
| [`engine_api_deploy`](_dispatches/2026-06-10_cc-agent-E_engine_api_deploy.md) | hauska-engine | cc-agent-E | C1 prereq | **FIRE-READY** — deploy engine-api to Cloud Run (the reasoning tier; **ICC-independent**) |
| [`gate_wire_engine_api`](_dispatches/2026-06-10_cc-agent-M_gate_wire_engine_api.md) | hauska-mcp-server | cc-agent-M | C1 prereq | QUEUED → after engine-api deploy (wire gate→engine-api + migration 004) |
| [`auth_preserve_anonymous_path`](_dispatches/2026-06-10_cc-agent-C_auth_preserve_anonymous_path.md) | legacy-design-tools | cc-agent-C | auth fix | **FIRE-READY — HIGH** (task #29 deploy locked out existing engagements; restore anonymous demo path per phased-7k; lets us redeploy #163–167) |
| [`C1_cortex_cut_to_gate`](_dispatches/2026-06-10_cc-agent-C_C1_cortex_cut_to_gate.md) | legacy-design-tools | cc-agent-C | C1 | **FIRE-READY** after engine-api deployed + gate wired (the big cut: Cortex→gate + S1 precedence wire + provenance envelope) |
