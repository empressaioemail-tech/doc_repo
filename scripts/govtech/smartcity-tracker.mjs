...
export const MILESTONES = [
  ...
  { id: 'M3', name: 'Lens builds on Bastrop live data', rows: ['G-135', 'G-161', 'G-154', 'G-149', 'G-153', 'G-152', 'G-151', 'G-155', 'G-150', 'G-165'] },
  { id: 'M4', name: 'DigitalOcean migration complete', rows: ['D-5', 'D-9', 'D-10', 'D-11', 'D-13', 'D-14', 'G-163'] },
  { id: 'M5', name: 'Design complete, and the controls that keep it honest', rows: ['G-146', 'G-142', 'G-147', 'G-148', 'G-160', 'G-164', 'G-166'] },
];
