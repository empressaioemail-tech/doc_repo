...
## 1. The Bastrop overlap. Answer it before designing anything.
...
## 2. Fix the instrument before you trust its answer

`measure-setback-provenance.mjs` is the only instrument that can settle item 1,
