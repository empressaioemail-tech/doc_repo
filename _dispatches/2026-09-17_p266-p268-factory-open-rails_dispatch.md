...
PLAN-ROW: P-266, P-268 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-factory
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p266-p268-factory-open-rails --seat <your-seat-id> --plan-row P-266 --dispatch _dispatches/2026-09-17_p266-p268-factory-open-rails_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p266-p268-factory-open-rails --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-17_p266-p268-factory-open-rails_cp1.json
  CP2: _inbox/2026-09-17_p266-p268-factory-open-rails_cp2.json
  CLOSE: _inbox/2026-09-17_p266-p268-factory-open-rails_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p266-p268-factory-open-rails",
    "planRows": ["P-266", "P-268"],
