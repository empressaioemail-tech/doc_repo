...
PLAN-ROW: G-148 (90_operations/OPS-17_govtech_stack_plan_of_record.md)
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane g148-design-instruments --seat <your-seat-id> --plan-row G-148 --dispatch _dispatches/2026-09-18_g148-design-instruments_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane g148-design-instruments --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  ...
  CLOSE: _inbox/2026-09-18_g148-design-instruments_close.json
