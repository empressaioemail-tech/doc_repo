...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p293-verdict-vocabulary --seat <your-seat-id> --plan-row P-293 --dispatch _dispatches/2026-09-16_p293-verdict-vocabulary_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p293-verdict-vocabulary --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-16_p293-verdict-vocabulary_cp1.json
  CP2: _inbox/2026-09-16_p293-verdict-vocabulary_cp2.json
  CLOSE: _inbox/2026-09-16_p293-verdict-vocabulary_close.json
