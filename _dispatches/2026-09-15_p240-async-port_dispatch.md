...
PLAN-ROW: P-240 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-engine

CLAIM YOUR LANE BEFORE YOU DO ANYTHING ELSE. This dispatch may have been handed to
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:

  node scripts/lane-claim.mjs claim --lane p240-async-port --seat <your-seat-id> --plan-row P-240 --dispatch _dispatches/2026-09-15_p240-async-port_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p240-async-port --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-15_p240-async-port_cp1.json
  CP2: _inbox/2026-09-15_p240-async-port_cp2.json
  CLOSE: _inbox/2026-09-15_p240-async-port_close.json
