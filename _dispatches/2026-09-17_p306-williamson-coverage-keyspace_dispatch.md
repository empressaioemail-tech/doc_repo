...
PLAN-ROW: P-306 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-factory
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p306-williamson-coverage-keyspace --seat <your-seat-id> --plan-row P-306 --dispatch _dispatches/2026-09-17_p306-williamson-coverage-keyspace_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p306-williamson-coverage-keyspace --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-17_p306-williamson-coverage-keyspace_cp1.json
  CP2: _inbox/2026-09-17_p306-williamson-coverage-keyspace_cp2.json
  CLOSE: _inbox/2026-09-17_p306-williamson-coverage-keyspace_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p306-williamson-coverage-keyspace",
    "planRows": ["P-306"],
