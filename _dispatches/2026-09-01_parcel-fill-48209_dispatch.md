...
# PARCEL-FILL-48209 dispatch

# Mission — fill the parcel record: Hays (48209), whole county
...
of Hays. Nothing serialises the six county fills; they run in parallel.

## This county's measured shape

- 154,313 parcels with dollar fields at source; livingArea 54.3%.
- Roll atoms are HOLLOW (265,881 bodies, 29 claim keys) — irrelevant to this fill because you never read them; named so their emptiness never becomes your surprise.
- Setbacks: Hays is 100% placeholder rules — a placeholder is NOT a value; the setback rails stay honest (unaccounted or what the module assigns), never placeholder-derived.
...
`_inbox/2026-09-01_parcel-fill-48209_close.json` with per-rail state counts for the
county, `whatContradictedTheCard` (mandatory), `leave_behind`, scratch block.

CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-01_parcel-fill-48209_cp1.json
  CP2: _inbox/2026-09-01_parcel-fill-48209_cp2.json
  CLOSE: _inbox/2026-09-01_parcel-fill-48209_close.json
