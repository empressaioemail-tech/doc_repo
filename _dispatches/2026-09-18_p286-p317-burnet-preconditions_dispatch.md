...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p286-p317-burnet-preconditions --seat <your-seat-id> --plan-row P-286 --dispatch _dispatches/2026-09-18_p286-p317-burnet-preconditions_dispatch.md
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-18_p286-p317-burnet-preconditions_cp1.json
  CP2: _inbox/2026-09-18_p286-p317-burnet-preconditions_cp2.json
  CLOSE: _inbox/2026-09-18_p286-p317-burnet-preconditions_close.json
