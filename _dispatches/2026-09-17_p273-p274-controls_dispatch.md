...
PLAN-ROW: P-273, P-274 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-factory
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p273-p274-controls --seat <your-seat-id> --plan-row P-273 --dispatch _dispatches/2026-09-17_p273-p274-controls_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p273-p274-controls --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-17_p273-p274-controls_cp1.json
  CP2: _inbox/2026-09-17_p273-p274-controls_cp2.json
  CLOSE: _inbox/2026-09-17_p273-p274-controls_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p273-p274-controls",
    "planRows": ["P-273", "P-274"],
