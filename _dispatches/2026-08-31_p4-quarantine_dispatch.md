...
PLAN-ROW: F-11, F-06 (90_operations/OPS-19_factory_plan_of_record.md)
repo: hauska-engine

# Repair the instrument, then disposition the two quarantines that gate the Bastrop setback bake
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-08-31_p4-quarantine_cp1.json
  CP2: _inbox/2026-08-31_p4-quarantine_cp2.json
  CLOSE: _inbox/2026-08-31_p4-quarantine_close.json
