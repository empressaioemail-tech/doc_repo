...
PLAN-ROW: P-238 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-engine

CLAIM YOUR LANE BEFORE YOU DO ANYTHING ELSE. This dispatch may have been handed to
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:

  node scripts/lane-claim.mjs claim --lane p238-dossier-footer-deep-link --seat <your-seat-id> --plan-row P-238 --dispatch _dispatches/2026-09-16_p238-dossier-footer-deep-link_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p238-dossier-footer-deep-link --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-16_p238-dossier-footer-deep-link_cp1.json
  CP2: _inbox/2026-09-16_p238-dossier-footer-deep-link_cp2.json
  CLOSE: _inbox/2026-09-16_p238-dossier-footer-deep-link_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p238-dossier-footer-deep-link",
    "planRows": ["P-238"],
