...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p259-austin-zoning-source --seat <your-seat-id> --plan-row P-259 --dispatch _dispatches/2026-09-17_p259-austin-zoning-source_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p259-austin-zoning-source --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-17_p259-austin-zoning-source_cp1.json
  CP2: _inbox/2026-09-17_p259-austin-zoning-source_cp2.json
  CLOSE: _inbox/2026-09-17_p259-austin-zoning-source_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p259-austin-zoning-source",
    "planRows": ["P-259"],
