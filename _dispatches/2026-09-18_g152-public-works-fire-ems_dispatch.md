...
PLAN-ROW: G-152 (90_operations/OPS-17_govtech_stack_plan_of_record.md)
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane g152-public-works-fire-ems --seat <your-seat-id> --plan-row G-152 --dispatch _dispatches/2026-09-18_g152-public-works-fire-ems_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane g152-public-works-fire-ems --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-18_g152-public-works-fire-ems_cp1.json
  CP2: _inbox/2026-09-18_g152-public-works-fire-ems_cp2.json
  CLOSE: _inbox/2026-09-18_g152-public-works-fire-ems_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "g152-public-works-fire-ems",
    "planRows": ["G-152"],
