...
PLAN-ROW: P-247 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-map

CLAIM YOUR LANE BEFORE YOU DO ANYTHING ELSE. This dispatch may have been handed to
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:

  node scripts/lane-claim.mjs claim --lane p247-smartsite-signin-redesign --seat <your-seat-id> --plan-row P-247 --dispatch _dispatches/2026-09-16_p247-smartsite-signin-redesign_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p247-smartsite-signin-redesign --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-16_p247-smartsite-signin-redesign_cp1.json
  CP2: _inbox/2026-09-16_p247-smartsite-signin-redesign_cp2.json
  CLOSE: _inbox/2026-09-16_p247-smartsite-signin-redesign_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p247-smartsite-signin-redesign",
    "planRows": ["P-247"],
