...
# PARCEL-FILL-48453 dispatch

# Mission — fill the parcel record: Travis (48453), whole county
...
of Travis. Nothing serialises the six county fills; they run in parallel.

## This county's measured shape

- 494,364 parcels with dollar fields at source; livingArea 0 of 500,307 at source.
- Roll atoms HOLLOW (492,851 bodies, 3 claim keys); never read them.
- Travis SERVES zoning live while the county ledger scores it 0.00% — the ledger measures whether a scorer ran, never whether data exists; ignore it entirely in this card.
- Largest county in the program; size chunks accordingly and do not straddle the maintenance window.
...
`_inbox/2026-09-01_parcel-fill-48453_close.json` with per-rail state counts for the
county, `whatContradictedTheCard` (mandatory), `leave_behind`, scratch block.

CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-01_parcel-fill-48453_cp1.json
  CP2: _inbox/2026-09-01_parcel-fill-48453_cp2.json
  CLOSE: _inbox/2026-09-01_parcel-fill-48453_close.json
