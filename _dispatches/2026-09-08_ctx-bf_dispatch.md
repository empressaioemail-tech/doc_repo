...
# buildingFootprint reconciliation: wire and run the merged job
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-08_ctx-bf_cp1.json
  CP2: _inbox/2026-09-08_ctx-bf_cp2.json
  CLOSE: _inbox/2026-09-08_ctx-bf_close.json
