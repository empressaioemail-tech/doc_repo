...
PLAN-ROW: P-103 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-map

# Retire the legacy install-scoped checkout seam
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-01_p103-seam_cp1.json
  CP2: _inbox/2026-09-01_p103-seam_cp2.json
  CLOSE: _inbox/2026-09-01_p103-seam_close.json
