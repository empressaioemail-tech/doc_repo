...
PLAN-ROW: G-127 (90_operations/OPS-17_govtech_stack_plan_of_record.md)
repo: smartcity-dashboards

CLAIM YOUR LANE BEFORE YOU DO ANYTHING ELSE. This dispatch may have been handed to
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:

  node scripts/lane-claim.mjs claim --lane g127-rbac --seat <your-seat-id> --plan-row G-127 --dispatch _dispatches/2026-09-14_g127-rbac_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane g127-rbac --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-14_g127-rbac_cp1.json
  CP2: _inbox/2026-09-14_g127-rbac_cp2.json
  CLOSE: _inbox/2026-09-14_g127-rbac_close.json
