...
PLAN-ROW: G-111 (90_operations/OPS-17_govtech_stack_plan_of_record.md)
repo: hauska-mcp-server

# Substrate — ICC obligation ledger: request_id echo-back + reader
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-02_substrate-icc-ledger_cp1.json
  CP2: _inbox/2026-09-02_substrate-icc-ledger_cp2.json
  CLOSE: _inbox/2026-09-02_substrate-icc-ledger_close.json
