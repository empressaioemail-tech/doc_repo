...
PLAN-ROW: P-248, P-261 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-engine
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p248-p261-footprints-pdf-figure --seat <your-seat-id> --plan-row P-248 --dispatch _dispatches/2026-09-16_p248-p261-footprints-pdf-figure_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p248-p261-footprints-pdf-figure --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-16_p248-p261-footprints-pdf-figure_cp1.json
  CP2: _inbox/2026-09-16_p248-p261-footprints-pdf-figure_cp2.json
  CLOSE: _inbox/2026-09-16_p248-p261-footprints-pdf-figure_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p248-p261-footprints-pdf-figure",
    "planRows": ["P-248", "P-261"],
