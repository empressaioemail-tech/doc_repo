...
PLAN-ROW: P-295 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-engine
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p295-ledger-serving-measure --seat <your-seat-id> --plan-row P-295 --dispatch _dispatches/2026-09-16_p295-ledger-serving-measure_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p295-ledger-serving-measure --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-16_p295-ledger-serving-measure_cp1.json
  CP2: _inbox/2026-09-16_p295-ledger-serving-measure_cp2.json
  CLOSE: _inbox/2026-09-16_p295-ledger-serving-measure_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p295-ledger-serving-measure",
    "planRows": ["P-295"],
