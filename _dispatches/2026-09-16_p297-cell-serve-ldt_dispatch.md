...
PLAN-ROW: P-297, P-269 (90_operations/OPS-16_texas_market_plan_of_record.md)
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p297-cell-serve-ldt --seat <your-seat-id> --plan-row P-297 --dispatch _dispatches/2026-09-16_p297-cell-serve-ldt_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p297-cell-serve-ldt --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-16_p297-cell-serve-ldt_cp1.json
  CP2: _inbox/2026-09-16_p297-cell-serve-ldt_cp2.json
  CLOSE: _inbox/2026-09-16_p297-cell-serve-ldt_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p297-cell-serve-ldt",
    "planRows": ["P-297", "P-269"],
