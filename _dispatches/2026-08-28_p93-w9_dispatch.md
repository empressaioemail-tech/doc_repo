...
PLAN-ROW: P-93 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-map

# P-93 Smart Site kit write-path (QA W9)
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-08-28_p93-w9_cp1.json
  CP2: _inbox/2026-08-28_p93-w9_cp2.json
  CLOSE: _inbox/2026-08-28_p93-w9_close.json
