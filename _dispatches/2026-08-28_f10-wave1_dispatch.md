...
# F-10 wave 1: the CAD roll for all 254 Texas counties through the conformant writer, one recorded run per county, defect rows before the loop, manifest cells reading verdicts per node (F-05); START GATED on four conditions, then CP3 on all six A-010 criteria with chunked counties and an explained replay (A-016)
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-08-28_f10-wave1_cp1.json
  CP2: _inbox/2026-08-28_f10-wave1_cp2.json
  CLOSE: _inbox/2026-08-28_f10-wave1_close.json
