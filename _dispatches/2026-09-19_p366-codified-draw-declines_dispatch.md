...
PLAN-ROW: P-366 (90_operations/OPS-16_texas_market_plan_of_record.md)
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p366-codified-draw-declines --seat <your-seat-id> --plan-row P-366 --dispatch _dispatches/2026-09-19_p366-codified-draw-declines_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p366-codified-draw-declines --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-19_p366-codified-draw-declines_cp1.json
  CP2: _inbox/2026-09-19_p366-codified-draw-declines_cp2.json
  CLOSE: _inbox/2026-09-19_p366-codified-draw-declines_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p366-codified-draw-declines",
    "planRows": ["P-366"],
