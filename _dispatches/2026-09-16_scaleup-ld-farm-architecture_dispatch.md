...
PLAN-ROW: P-187, P-198 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: doc_repo

CLAIM YOUR LANE BEFORE YOU DO ANYTHING ELSE. This dispatch may have been handed to
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:

  node scripts/lane-claim.mjs claim --lane scaleup-ld-farm-architecture --seat <your-seat-id> --plan-row P-187 --dispatch _dispatches/2026-09-16_scaleup-ld-farm-architecture_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane scaleup-ld-farm-architecture --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  ...
  CLOSE: _inbox/2026-09-16_scaleup-ld-farm-architecture_close.json
