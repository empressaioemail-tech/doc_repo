...
PLAN-ROW: P-362 (90_operations/OPS-16_texas_market_plan_of_record.md)
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p362-post-shift-check --seat <your-seat-id> --plan-row P-362 --dispatch _dispatches/2026-09-18_p362-post-shift-check_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p362-post-shift-check --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-18_p362-post-shift-check_cp1.json
  CP2: _inbox/2026-09-18_p362-post-shift-check_cp2.json
  CLOSE: _inbox/2026-09-18_p362-post-shift-check_close.json
