...
PLAN-ROW: P-340 (90_operations/OPS-16_texas_market_plan_of_record.md)
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p340-card-route-table --seat <your-seat-id> --plan-row P-340 --dispatch _dispatches/2026-09-19_p340-card-route-table_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p340-card-route-table --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-19_p340-card-route-table_cp1.json
  CP2: _inbox/2026-09-19_p340-card-route-table_cp2.json
  CLOSE: _inbox/2026-09-19_p340-card-route-table_close.json
