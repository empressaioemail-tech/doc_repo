...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane engine-deploy-p260-p263 --seat <your-seat-id> --plan-row P-260 --dispatch _dispatches/2026-09-17_engine-deploy-p260-p263_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane engine-deploy-p260-p263 --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-17_engine-deploy-p260-p263_cp1.json
  CP2: _inbox/2026-09-17_engine-deploy-p260-p263_cp2.json
  CLOSE: _inbox/2026-09-17_engine-deploy-p260-p263_close.json
