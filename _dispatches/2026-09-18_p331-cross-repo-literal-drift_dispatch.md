...
PLAN-ROW: P-331 (90_operations/OPS-16_texas_market_plan_of_record.md)
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p331-cross-repo-literal-drift --seat <your-seat-id> --plan-row P-331 --dispatch _dispatches/2026-09-18_p331-cross-repo-literal-drift_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p331-cross-repo-literal-drift --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-18_p331-cross-repo-literal-drift_cp1.json
  CP2: _inbox/2026-09-18_p331-cross-repo-literal-drift_cp2.json
  CLOSE: _inbox/2026-09-18_p331-cross-repo-literal-drift_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "p331-cross-repo-literal-drift",
    "planRows": ["P-331"],
