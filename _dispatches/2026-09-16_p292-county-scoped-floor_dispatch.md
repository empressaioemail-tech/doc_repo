...
PLAN-ROW: P-292 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: hauska-factory
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p292-county-scoped-floor --seat <your-seat-id> --plan-row P-292 --dispatch _dispatches/2026-09-16_p292-county-scoped-floor_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p292-county-scoped-floor --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-16_p292-county-scoped-floor_cp1.json
  CP2: _inbox/2026-09-16_p292-county-scoped-floor_cp2.json
  CLOSE: _inbox/2026-09-16_p292-county-scoped-floor_close.json
