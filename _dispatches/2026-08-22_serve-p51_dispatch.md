...
# SERVE P-51 buildingFootprintFact scout then cortex
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-08-22_serve-p51_cp1.json
  CP2: _inbox/2026-08-22_serve-p51_cp2.json
  CLOSE: _inbox/2026-08-22_serve-p51_close.json
