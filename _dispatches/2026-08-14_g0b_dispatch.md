...
PLAN-ROW: G-07 (90_operations/OPS-17_govtech_stack_plan_of_record.md)
repo: doc_repo

# Repo cartography — map every folder, classify what is out of scope
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-08-14_g0b_cp1.json
  CP2: _inbox/2026-08-14_g0b_cp2.json
  CLOSE: _inbox/2026-08-14_g0b_close.json
