...
PLAN-ROW: P-249, P-248 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: doc_repo

CLAIM YOUR LANE BEFORE YOU DO ANYTHING ELSE. This dispatch may have been handed to
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:

  node scripts/lane-claim.mjs claim --lane scaleup-lb-envelope-roads --seat <your-seat-id> --plan-row P-249 --dispatch _dispatches/2026-09-16_scaleup-lb-envelope-roads_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane scaleup-lb-envelope-roads --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-16_scaleup-lb-envelope-roads_cp1.json
  CP2: _inbox/2026-09-16_scaleup-lb-envelope-roads_cp2.json
  CLOSE: _inbox/2026-09-16_scaleup-lb-envelope-roads_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "scaleup-lb-envelope-roads",
    "planRows": ["P-249", "P-248"],
