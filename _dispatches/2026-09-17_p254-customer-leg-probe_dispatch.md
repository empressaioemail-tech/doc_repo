...
PLAN-ROW: P-254 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: doc_repo
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane p254-customer-leg-probe --seat <your-seat-id> --plan-row P-254 --dispatch _dispatches/2026-09-17_p254-customer-leg-probe_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane p254-customer-leg-probe --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-17_p254-customer-leg-probe_cp1.json
  CP2: _inbox/2026-09-17_p254-customer-leg-probe_cp2.json
  CLOSE: _inbox/2026-09-17_p254-customer-leg-probe_close.json
