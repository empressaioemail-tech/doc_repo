...
# PARCEL-FILL-48309 dispatch

# Mission — fill the parcel record: McLennan (48309), whole county
...
of McLennan. Nothing serialises the six county fills; they run in parallel.

## This county's measured shape

- 113,360 parcels with dollar fields at source, BUT assessed value and living area are 0 at source — absence at the CAD authority is the real state for those rails. Filling them would be inventing values; the honest state per the module's NULL-at-source mapping (from the sample close) is the correct outcome for the whole county.
...
`_inbox/2026-09-01_parcel-fill-48309_close.json` with per-rail state counts for the
county, `whatContradictedTheCard` (mandatory), `leave_behind`, scratch block.

CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-01_parcel-fill-48309_cp1.json
  CP2: _inbox/2026-09-01_parcel-fill-48309_cp2.json
  CLOSE: _inbox/2026-09-01_parcel-fill-48309_close.json
