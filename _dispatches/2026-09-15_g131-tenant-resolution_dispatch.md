...
PLAN-ROW: G-131 (90_operations/OPS-17_govtech_stack_plan_of_record.md)
repo: smartcity-os

CLAIM YOUR LANE BEFORE YOU DO ANYTHING ELSE. This dispatch may have been handed to
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:

  node scripts/lane-claim.mjs claim --lane g131-tenant-resolution --seat <your-seat-id> --plan-row G-131 --dispatch _dispatches/2026-09-15_g131-tenant-resolution_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane g131-tenant-resolution --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-15_g131-tenant-resolution_cp1.json
  CP2: _inbox/2026-09-15_g131-tenant-resolution_cp2.json
  CLOSE: _inbox/2026-09-15_g131-tenant-resolution_close.json
