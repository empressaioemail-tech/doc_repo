---
id: 2026-05-28_central-tx-property-brief-scope
title: Central TX Property Brief — execution scope (paywall deferred)
date: 2026-05-28
agent: planner
repo: doc_repo
kind: scope
related: [75_hauska_brokerage_workflow_plan, 75b_brief_coverage_v0, 75a_hauska_brief_extension, 77_place_graph_strategy, 25_atom_architecture_reference]
---

# Central TX Property Brief — execution scope (paywall deferred)

**Status:** Active — deploy gated on PR #134 fix (2026-05-29)  
...
**Sprint backlog:** [`75c_property_brief_data_backlog.md`](../75c_property_brief_data_backlog.md) · **Decision:** [`_decisions/2026-05-29_property_brief_data_backlog_priorities.md`](../_decisions/2026-05-29_property_brief_data_backlog_priorities.md)

**Planning kickoff:** `_inbox/2026-05-28_legacy-design-tools_cursor-auto_central-tx-property-brief_planning_kickoff.md`  
**Assigned dispatches:**

| Dispatch | Assignee | File |
|----------|----------|------|
| A | cc-agent-C | [`2026-05-28_dispatch-A_ldt_place-graph-brief.md`](2026-05-28_dispatch-A_ldt_place-graph-brief.md) |
| B | extension-agent | [`2026-05-28_dispatch-B_extension_brief-atom-ux.md`](2026-05-28_dispatch-B_extension_brief-atom-ux.md) |
| C | cc-agent-E | [`2026-05-28_dispatch-C_engine_central-tx-corpus-icc.md`](2026-05-28_dispatch-C_engine_central-tx-corpus-icc.md) |
| D | cc-agent-C | [`2026-05-29_cc-agent-C_brief_federal_site_context_layers.md`](2026-05-29_cc-agent-C_brief_federal_site_context_layers.md) |
| E | cc-agent-E | [`2026-05-29_cc-agent-E_neon_warmup_pilot_batch.md`](2026-05-29_cc-agent-E_neon_warmup_pilot_batch.md) |
| F | cc-agent-C | [`2026-05-29_cc-agent-C_brief_encumbrance_upload_path.md`](2026-05-29_cc-agent-C_brief_encumbrance_upload_path.md) |

**Backlog (scored):** [`75c_property_brief_data_backlog.md`](../75c_property_brief_data_backlog.md)

**Sequence:** fix + merge PR #134 → deploy `0030` → Neon load (JSONL ready) → extension v0.5.2 prod smoke → federal layers (D, parallel) → encumbrance R4 (F) → ICC when creds land.

**Deploy blocker:** PR [#134](https://github.com/empressaioemail-tech/legacy-design-tools/pull/134) — operator fixing CI/issues before merge (2026-05-29).

---

## Product thesis (atom vision alignment)

Per [`25_atom_architecture_reference.md`](../25_atom_architecture_reference.md) §5 + §9:
...
| 0e | Partnership rule: MOU → Plane E/B enrichment on place node only | Governance |
...
8. **`defaultJurisdiction` ignored** when server geocodes — documented in [`75a_hauska_brief_extension.md`](../75a_hauska_brief_extension.md).
