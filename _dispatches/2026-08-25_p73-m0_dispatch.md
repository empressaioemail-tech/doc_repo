...
PLAN-ROW: P-73 (90_operations/OPS-16_texas_market_plan_of_record.md)
repo: legacy-design-tools

# P-73 fleet memory travel compile (WDLL item 1)

<<< MISSION — replace this line with the hand-written mission section before dispatching >>>

CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-08-25_p73-m0_cp1.json
  CP2: _inbox/2026-08-25_p73-m0_cp2.json
  CLOSE: _inbox/2026-08-25_p73-m0_close.json
