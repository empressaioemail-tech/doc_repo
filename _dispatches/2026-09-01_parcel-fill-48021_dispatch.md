...
# PARCEL-FILL-48021 dispatch

# Mission — fill the parcel record: Bastrop (48021), whole county
...
of Bastrop. Nothing serialises the six county fills; they run in parallel.

## This county's measured shape

- 77,799 cad_property parcels; 77,164 with market value at source; livingArea real coverage 11.2% (8,712) while roll atoms INVENT 40,602 — the fill must reflect CAD, and the sample card proved it does not copy atoms.
- 6,158 real $0 improvements at source — land as `value: 0`.
- Gold parcel `48021:34137` must come out publishable-shaped on its filled rails; do not special-case it.
- Do not source Bastrop permits from SmartCity.
...
`_inbox/2026-09-01_parcel-fill-48021_close.json` with per-rail state counts for the
county, `whatContradictedTheCard` (mandatory), `leave_behind`, scratch block.

CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-01_parcel-fill-48021_cp1.json
  CP2: _inbox/2026-09-01_parcel-fill-48021_cp2.json
  CLOSE: _inbox/2026-09-01_parcel-fill-48021_close.json
