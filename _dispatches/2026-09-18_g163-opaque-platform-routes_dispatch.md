...
PLAN-ROW: G-163 (90_operations/OPS-17_govtech_stack_plan_of_record.md)
FAN-DEPTH: 0
...
more than one session. Run this FIRST, from the doc_repo worktree you are rooted in:
  ...
  node scripts/lane-claim.mjs claim --lane g163-opaque-platform-routes --seat <your-seat-id> --plan-row G-163 --dispatch _dispatches/2026-09-18_g163-opaque-platform-routes_dispatch.md
...
your close is filed:
  ...
  node scripts/lane-claim.mjs release --lane g163-opaque-platform-routes --seat <your-seat-id>
...
CHECKPOINTS AND CLOSE (exact paths; machine-checkable per contract section 6):
  CP1: _inbox/2026-09-18_g163-opaque-platform-routes_cp1.json
  CP2: _inbox/2026-09-18_g163-opaque-platform-routes_cp2.json
  CLOSE: _inbox/2026-09-18_g163-opaque-platform-routes_close.json
...
the commit rather than guessing what you meant):
  {
    "lane": "g163-opaque-platform-routes",
    "planRows": ["G-163"],
