...
| Dataroom tile | legacy-design-tools / cortex-api | RUNNING | Dataroom/Files tile: reuse Track D upload/GCS; per-file call to POST /v1/document-ingest; render extracted atoms as cited confidence-graded chips linked to sourceDocumentCid; firewall (private uploads default tenant-private); register in TILE_REGISTRY |
