...
| file->atom durability | hauska-engine / engine-api | RUNNING | wire persistent DocumentIngestStore (Postgres + GCS) per the shaped port so minted atoms + dedup survive restarts |
