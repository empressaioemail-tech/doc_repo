...
<!-- DRAFT for operator review. Target path: 80_adrs/adr_025_og_atom_ontology.md (025 is the next available ADR slot; 024 is shared surface package architecture). -->
