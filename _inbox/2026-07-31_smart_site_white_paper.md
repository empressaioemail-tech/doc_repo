---
id: 2026-07-31_smart_site_white_paper
title: White Paper — The Smart Site: A Verifiable Data Layer for the Physical World
date: 2026-07-31
status: white paper (draft v1 — substance-altitude; investor / city-exec / sophisticated-partner audience)
owner: nick
related: [42_stub_thesis_national_twin_substrate, 41_three_wedge_spine_strategy, 2026-07-31_smart_site_smart_city_positioning, 09_post_saas_substrate_thesis]
purpose: The full argument, written as persuasion-through-substance. For a serious reader (investor, city executive, sophisticated developer/partner) who needs to understand why this is inevitable and why it is us. Substance altitude — the argument may reference the deeper mechanics (verifiable records, agent consumption, the emerging real-world-asset market) that mass-market copy omits, but it earns every claim.
---
...
*This paper is a substance-altitude document for serious readers. Mass-market positioning omits the deeper mechanics by design (see the two-altitude rule); this paper earns them.*
