---
id: 2026-08-25_county19_hood_48221_handoff
title: Handoff — Texas leftover county 19 is Hood 48221
date: 2026-08-25
status: ready_after_guadalupe_keep
plan_row: P-78
...
Guadalupe 48187 KEEP is filed. This child writes one leftover county. Quote `--vintage`. One FIPS. Then stop. Do not spawn. Do not commit.

---

You are writing one leftover county onto `cad_property`. The county is **Hood 48221**. Not Guadalupe rewrite. Not Gillespie. Not Hunt. Not Dallas. Not Tarrant.
...
L17 is the inspect vintage pin, not a stop. Leftover still writes. Registry row `tx-48221` has `current_tax_year` null and `current_tier` null. Do not write a declared vintage onto the registry. Do not flip L17.
...
- Already written. Do not rewrite: Caldwell 48055 @ 2025 n=24989. Bastrop 48021 @ 2025 n=77799. Hays 48209 @ 2025 n=172116. Williamson 48491 @ 2025 n=282570. Travis 48453 @ 2025 n=380918. Atascosa 48013 @ 2025 n=34649. Bandera 48019 @ 2025 n=32755. Bexar 48029 @ 2025 n=703258. Blanco 48031 @ 2025 n=13648. Burnet 48053 @ 2025 n=49243. Collin 48085 @ 2025 n=387334. Comal 48091 @ 2025 n=103207. Denton 48121 @ 2025 n=351798. Ellis 48139 @ 2025 n=98150. Fayette 48149 @ 2025 n=22432. Frio 48163 @ 2025 n=12489. Gillespie 48171 @ 2025 n=31452. Guadalupe 48187 @ 2025 n=93728. Confirm those from `_inbox/2026-08-25_leftover_queue.md` before you write.
...
5. `_inbox/2026-08-25_review_guadalupe_48187_leftover.md` (must be KEEP)
6. This file
...
Copy `scripts/fixtures/cad-ingest-apply-gate/packet.template.json` to `_inbox/2026-08-25_p78_announce_hood_48221_packet.json`.

## Packet rules

1. FIPS is `48221`. `countyCount=1`. `secondCounty=false`.
2. All-year census, no `tax_year =` filter. Literal `'48221'`. File leftover year and declared L17 year even if n=0.
...
```
node scripts/cad-ingest-apply-gate.mjs --check --packet _inbox/2026-08-25_p78_announce_hood_48221_packet.json
```
...
Announce `_inbox/2026-08-25_p78_announce_hood_48221.md` before the upsert log starts. Keep after-counts out of the pre-apply announce. Isolated LDT at `46e1a5a1`. `--county=48221` only. No fallback flag.

Quote `--vintage` in PowerShell. Set `NODE_OPTIONS=--use-system-ca`.

```
pnpm --filter @workspace/cad-ingest stratmap-landuse -- --county=48221 "--vintage=tier:stratmap-roll;adapter:stratmap;drop:stratmap25-landparcels_48221_lp"
```

Confirm the drop name from the zip / CLI. File before JSON, apply log, after JSON. Count prop_id `0` and do not call it success.

If leftover year equals a declared store year that inspect would read, probe one Hood inspect parcel. If leftover year is off that year, or L17 is undeclared, skip the inspect probe and say why. Do not use `48021:34137`, `48453:280238`, `48029:262160`, `48085:10000`, `48091:10003`, `48121:10`, or `48187:106109`.

Then stop. File `_inbox/2026-08-25_p78_hood_48221_leftover_close.json` with leave_behind. Do not commit.

## Do not

48187 rewrite. 48171. 48163. 48149. 48139. 48121. 48091. 48085. 48053. 48031. 48029. 48019. 48013. 48021. 48055. 48209. 48491. 48453. 48113. 48439. 48231. P-80. 280238 overlay. L17 / registry flip. Atoms `--apply`. Rematerialize. Gold 2800 restore. Memory pin raise. A second county in the same session.
