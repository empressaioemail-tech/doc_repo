...
3. Comal land-use source with a populated PTAD state category (licensed ComalCAD roll, or a StratMap vintage where STAT_LAND_ is non-blank). Recovers ~103k Comal parcels.
