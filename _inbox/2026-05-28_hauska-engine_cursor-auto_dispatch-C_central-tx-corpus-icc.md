...
repo: hauska-engine
type: session
topic: dispatch_C_central_tx_corpus_icc
dispatch_to: _dispatches/2026-05-28_dispatch-C_engine_central-tx-corpus-icc.md
assignee: cc-agent-E
...
- `75b` coverage table matches engine snapshot counts.
...
City/county MOUs add **Plane E/B enrichment APIs into `property-workspace` place node only** — never a parallel code path. Planner to append `73_partnerships.md`.
