...
async function main() {
  ...
  writeFileSync(join(INBOX, `2026-08-08_L2_${WAVE_TAG}_${fips}_a2_dry.log`), dry.text, "utf8");
  ...
  writeFileSync(
    join(INBOX, `2026-08-08_L2_${WAVE_TAG}_${fips}_a2_apply1.log`),
    apply1.text,
    "utf8"
  );
  result.apply1 = {
  ...
  writeFileSync(
    join(INBOX, `2026-08-08_L2_${WAVE_TAG}_${fips}_a2_apply2.log`),
    apply2.text,
    "utf8"
  );
  result.apply2 = {
