---
id: 2026-08-25_county16_frio_48163_handoff
title: Handoff — Texas leftover county 16 is Frio 48163
date: 2026-08-25
status: ready_after_fayette_keep
plan_row: P-78
...
Fayette 48149 KEEP is filed. This child writes one leftover county. Quote `--vintage`. One FIPS. Then stop. Do not spawn. Do not commit.

Frio CAD REST is honest_absent. Leftover still uses the StratMap zip. Do not treat the missing county REST as a leftover stop.

---

You are writing one leftover county onto `cad_property`. The county is **Frio 48163**. Not Fayette rewrite. Not Ellis. Not Gillespie. Not Dallas. Not Tarrant.
...
L17 is the inspect vintage pin, not a stop. Leftover still writes. Registry row `tx-48163` has `current_tax_year` null and `current_tier` null. Do not write a declared vintage onto the registry. Do not flip L17.
...
- Already written. Do not rewrite: Caldwell 48055 @ 2025 n=24989. Bastrop 48021 @ 2025 n=77799. Hays 48209 @ 2025 n=172116. Williamson 48491 @ 2025 n=282570. Travis 48453 @ 2025 n=380918. Atascosa 48013 @ 2025 n=34649. Bandera 48019 @ 2025 n=32755. Bexar 48029 @ 2025 n=703258. Blanco 48031 @ 2025 n=13648. Burnet 48053 @ 2025 n=49243. Collin 48085 @ 2025 n=387334. Comal 48091 @ 2025 n=103207. Denton 48121 @ 2025 n=351798. Ellis 48139 @ 2025 n=98150. Fayette 48149 @ 2025 n=22432. Confirm those from `_inbox/2026-08-25_leftover_queue.md` before you write.
...
5. `_inbox/2026-08-25_review_fayette_48149_leftover.md` (must be KEEP)
6. This file
...
Copy `scripts/fixtures/cad-ingest-apply-gate/packet.template.json` to `_inbox/2026-08-25_p78_announce_frio_48163_packet.json`.

## Packet rules

1. FIPS is `48163`. `countyCount=1`. `secondCounty=false`.
2. All-year census, no `tax_year =` filter. Literal `'48163'`. File leftover year and declared L17 year even if n=0.
...
```
node scripts/cad-ingest-apply-gate.mjs --check --packet _inbox/2026-08-25_p78_announce_frio_48163_packet.json
```
...
Announce `_inbox/2026-08-25_p78_announce_frio_48163.md` before the upsert log starts. Keep after-counts out of the pre-apply announce. Isolated LDT at `46e1a5a1`. `--county=48163` only. No fallback flag.

Quote `--vintage` in PowerShell. Set `NODE_OPTIONS=--use-system-ca`.

```
pnpm --filter @workspace/cad-ingest stratmap-landuse -- --county=48163 "--vintage=tier:stratmap-roll;adapter:stratmap;drop:stratmap25-landparcels_48163_lp"
```

Confirm the drop name from the zip / CLI. File before JSON, apply log, after JSON. Count prop_id `0` and do not call it success.

If leftover year equals a declared store year that inspect would read, probe one Frio inspect parcel. If leftover year is off that year, or L17 is undeclared, skip the inspect probe and say why.

Then stop. File `_inbox/2026-08-25_p78_frio_48163_leftover_close.json` with leave_behind. Do not commit.

## Do not

48149 rewrite. 48139. 48121. 48091. 48085. 48053. 48031. 48029. 48019. 48013. 48021. 48055. 48209. 48491. 48453. 48113. 48439. P-80. 280238 overlay. L17 / registry flip. Atoms `--apply`. Rematerialize. Gold 2800 restore. Memory pin raise. A second county in the same session.
