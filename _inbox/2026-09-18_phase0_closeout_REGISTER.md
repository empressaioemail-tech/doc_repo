...
| 2 Customer | `scripts/surface-probe.mjs` passes on map, MCP and PDF; XD/X open count zero or ruled | **45 buckets: 0 PASS, 12 FAIL, 33 UNMEASURED; 6 of 23 XD/X OPEN, 10 CLOSED, 7 UNMEASURED; PDF SERVED 52 of 52.** No bucket can pass until the MCP half is measured (P-347's sign-in) | 2026-09-18 14:05:16Z (`_inbox/2026-09-18_140516_surface_probe.json`, instrument `a1590f84`) | P-347's MCP leg, P-323 then the LDT deploy, P-339 to P-341, P-342's apply, P-335 (XD-7), P-349, P-354, P-270's address half |
| 3 Coverage | P-205, P-210 | **P-210 PASS 3 of 3** (the derived covered set names Milam and Burnet). **P-205 FAIL 4 of 4 on the map** (the Find box drops the coverage answer, P-353); MCP half unmeasured | 2026-09-18 14:05:16Z | P-353, then P-347's MCP leg |
...
| #175 | Deploy `cloudbuild.parcel-record-fill.yaml` under the gate-scheduler procedure (pause the hourly trigger, deploy, grade a cycle, resume); no fill `--apply` before it | 1 | 1. **IN PROGRESS 2026-09-18:** trigger paused 14:01:34Z. Record `_inbox/2026-09-18_p325_175_deploy_RECORD.md` |
