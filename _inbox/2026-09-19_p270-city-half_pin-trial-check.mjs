...
export const LITERALS = [
  ...
  // P-270 CITY HALF (2026-09-19). The vocabulary the situs-city licence stamps
  // and the two words it reads. Declared under these NAMES on both sides for
  // exactly these rows: `SitusCityBasis` in map's
  // `apps/property-explorer/src/lib/situs-address.ts` and in LDT's
  // `artifacts/api-server/src/lib/situsCompose.ts`, with the two constants
  // beside each declaration. The probe's copy of the rule (doc_repo
