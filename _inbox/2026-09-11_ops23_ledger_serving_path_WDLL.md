...
| wave 2 | P-170 | TRAFFIC LEASE | One traffic shift at a time per service: contract clause, `_catalog/leases/`, hook `traffic-lease-gate`. | the hook observed refusing a shift without a lease, through the harness | ADDED 2026-09-12 (ruling 5); integration seat |
