...
|---|---|---|---|---|---|
| 1 | P-151 | SEAM | `48453:113408` seals with its fourteen facts and header `414 SPILLER LN`; placement seeds from the record point and the click, never a geocoder; `48453:474034` says unincorporated Travis; the cortex point route answers or refuses inside 10 s. | `surface-probe --rows P-151` plus the operator's screenshot in the close | dispatched, hand-carry ready (`_dispatches/2026-09-11_p151-seam_dispatch.md`) |
