...
- OPEN (2026-08-17): operator rejected Bastrop cutover as next. Sequence is G-66 UI (draft) then one source onto template-city. Three identities: template-city demo, live Bastrop island, next-city pack. Gold 48021:34137 is a demo fixture. Gap `_inbox/2026-08-17_dashboards_missing_pieces.md`. Decision `_decisions/2026-08-17_dashboards_ui_then_one_feed.md`.
