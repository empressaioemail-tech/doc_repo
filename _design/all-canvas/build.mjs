...
const ROWS = [
  ...
  },
  {
    ...
    note: 'DEVELOPMENT SERVICES — shipped G-123, 20 of 20 live checks.\nPermits, inspections, work orders, code enforcement and licences under one table treatment. Three tiers instead of two walls of numbers. The free-text description stays OUT of scannable lists: on the live system it carries residents’ names and phone numbers. That is a design decision here, not a control; the field still needs a real gate.',
    from: 'smartcity-dev-services',
    boards: [['Main.dc.html', 'DevServices', 'Pipeline — default tab'], ['WorkOrders.dc.html', 'DevServicesWorkOrders', 'Work orders — load + pagination'], ['Empty.dc.html', 'DevServicesEmpty', 'Empty pack']],
  },
  {
    surface: 'Map dock',
