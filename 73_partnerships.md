...
status: active
last_updated: 2026-05-22 (Sync 5 Tier 2 central-Texas recon: Kyle, Buda, Liberty Hill, Bee Cave added to the General Code eCode360 row, American Legal Publishing logged as a fourth publisher platform. Earlier 2026-05-22: Pflugerville and Cedar Park added to General Code, EncodePlus / GovOS logged. Prior 2026-05-21: Standards-body licensor partnerships section added.)
...
|---|---|---|---|
| **General Code (eCode360)** | Smithville, Pflugerville, Cedar Park, and the central-Texas eCode360 cities Kyle, Buda, Liberty Hill, and Bee Cave (instance IDs SM6484 / PF6442 / CE6271 / KY6871 / BU6262 / LI6389 / 40277793), plus many other small/mid-TX cities. Confirmed eCode360-blocked Sync 5 Tier 1 and Tier 2 cities per cc-agent-E's 2026-05-22 recons; the largest single access-blocked bucket in the central-Texas ingest. | **Partnership target — pending outreach.** Surfaced 2026-05-19 per cc-agent-E's Smithville structural-blocker recon at [`_sessions/2026-05-19_smithville_ecode360_blocker_cc-agent-E.md`](_sessions/2026-05-19_smithville_ecode360_blocker_cc-agent-E.md). | Smithville code on eCode360 returns HTTP 403 for both ingest and browser user-agents (bot protection); robots.txt disallows `/documents/`, `/search`. Direct ingest violates published policy. General Code's eCode360 partner API is the substantive-access path. Per Commitment #2 (partnership-first sourcing), this is a partnership conversation. |
