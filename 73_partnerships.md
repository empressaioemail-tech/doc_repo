...
status: active
last_updated: 2026-08-03 (ecode360-scraper named-not-proven note on the General Code row + retired-commitment citation flagged + Cotality-sole-spine reference corrected to the 2026-07-13 reversal (parcels on TxGIO/CAD + county-GIS public record; Cotality extinguished). Prior 2026-07-05 (Regrid-purged scrub: brief/public-records baseline recorded as Cotality, sole spine since 2026-06-17 — since reversed. Prior 2026-06-09 (partnership-first sourcing retired, reframed to customer/design-partner + content-licensing posture; prior 2026-05-29 Property Brief outreach wave + backlog cross-link. Prior 2026-05-26 Sync 5 TX-metros batch: McAllen confirmed eCode360 added to General Code row; 7 metro-suburb cities + Edinburg added to publisher-TBD bucket with Fort Worth flagged as the strategic anchor for the FW metro. Earlier 2026-05-22: Sync 5 Tier 2 central-Texas recon — Kyle, Buda, Liberty Hill, Bee Cave to General Code, American Legal Publishing logged. Prior 2026-05-22: Pflugerville and Cedar Park added to General Code, EncodePlus / GovOS logged. Prior 2026-05-21: Standards-body licensor partnerships section added.))
...
|---|---|---|---|
| **General Code (eCode360)** | Smithville, Pflugerville, Cedar Park, the central-Texas eCode360 cities Kyle, Buda, Liberty Hill, Bee Cave (instance IDs SM6484 / PF6442 / CE6271 / KY6871 / BU6262 / LI6389 / 40277793), McAllen TX (RGV, instance ID MC6775; confirmed eCode360 per cc-agent-E's 2026-05-23 TX-metros recon), plus many other small/mid-TX cities. Confirmed eCode360-blocked Sync 5 Tier 1, Tier 2, and TX-metros cities; the largest single access-blocked bucket in the Texas ingest. | **Outreach scheduled 2026-05-30 (Nick).** One-pager: [`90_runbooks/partner_outreach_brief_wave.md`](90_runbooks/partner_outreach_brief_wave.md) §1. Backlog item PB-101 in [`75c_property_brief_data_backlog.md`](75c_property_brief_data_backlog.md). | Smithville code on eCode360 returns HTTP 403 for both ingest and browser user-agents (bot protection); robots.txt disallows `/documents/`, `/search`. Direct ingest violates published policy. General Code's eCode360 partner API is the substantive-access path. (Historical note: this row originally cited Commitment #2 partnership-first sourcing, retired 2026-06-09; the routing now stands on the published-policy / 403 ground alone.) **2026-08-03 adversarial-review note:** an `ecode360-scraper` adapter is NAMED in the hauska-engine jurisdiction registry, but no successful ingest via it is demonstrated anywhere in the doc set or code history — "in the registry" means named, not proven-working, and it plausibly sits behind the same General Code wall. Do not plan Smithville (or any eCode360 city) coverage on the adapter until it proves an ingest; the partnership API remains the substantive path. |
...
| **Brief baseline** | FEMA + uniform public-record baseline via TxGIO/CAD + county-GIS (Regrid purged 2026-06-17; the 2026-06-17 "Cotality sole spine" posture was REVERSED 2026-07-13 — Cotality is extinguished, never re-credentialed; out of scope for city operational-data MOU) |
