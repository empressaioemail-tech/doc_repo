...
**Rendering / advanced capture (note 2026-05-19, updated 2026-05-22).** mnml.ai integration depth, image-to-BIM, and image-to-CAD were descoped to [`40b_advanced_capture_features.md`](40b_advanced_capture_features.md) with an explicit activation gate. **Lane 1, the mnml.ai render engine, was activated 2026-05-22** as the scoped Cortex rendering sprint at [`40c_cortex_rendering_sprint.md`](40c_cortex_rendering_sprint.md); it is the execution home of DA-12 below. Image-to-BIM and image-to-CAD (Lanes 2 and 3) stay queued. The `cortex/render_*` MCP tool surface is a tracked MCP retrofit follow-on per [`28_mcp_first_product_design.md`](28_mcp_first_product_design.md), to land on hauska-mcp-server after the Renders tab ships.
