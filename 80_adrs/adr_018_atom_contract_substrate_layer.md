...
The ECI internal atom registry (canonical name `@empressaio/atom-internal` per [`60_eci_atomization.md`](../60_eci_atomization.md) and CLAUDE.md identity section) was ratified 2026-05-18 per [`_decisions/2026-05-18_eci_registry_naming.md`](../_decisions/2026-05-18_eci_registry_naming.md). The package name is confirmed; the registry source lives in a dedicated repo at `empressaioemail-tech/empressa-atom-internal`. ECI atoms are Empressa-internal product memory (decisions, sprints, sessions, procedure-execution, actor-record); the Empressa namespace is structurally correct for that registry. The internal registry consumes the renamed `@hauska/atom-contract` as its base substrate. Sprint plan at [`60a_eci_atomization_sprint.md`](../60a_eci_atomization_sprint.md).
...
- [x] **Contract scope clarification (option β).** Per cc-agent-AC's 2026-05-18 first-session recon at [`_sessions/2026-05-18_hauska_atom_contract_bootstrap_and_port_cc-agent-AC.md`](../_sessions/2026-05-18_hauska_atom_contract_bootstrap_and_port_cc-agent-AC.md), the source `lib/empressa-atom/` package is framework-only; the 19 existing atom-type registrations live in `legacy-design-tools/artifacts/api-server/src/atoms/` with `@workspace/db` plus route-helper runtime deps that cannot lift into a published substrate package without inverting ADR-018's substrate-vs-product split. Option β selected by Nick: `@hauska/atom-contract@1.0.0` ships framework-only; all 28 atom-type registrations (19 existing in api-server; 6 MCP-exposed new in `hauska-engine/packages/atoms/`; 3 adjudication-context owned by `smartcity-os` Codex 1b) live in consumer packages, not inside the contract. Adding new atom types bumps the respective consumer-package version, not the contract version. The contract package stays at 1.0.0 absent framework changes (new render modes, `ContextSummary` field additions, etc.). Follow-on doc sweep applying this framing to [`51_substrate_v1_sprint.md`](../51_substrate_v1_sprint.md) §Bump 1, [`27_engine_evolution_plan.md`](../27_engine_evolution_plan.md) §Contract version bump, and [`26_atom_upgrade_guide.md`](../26_atom_upgrade_guide.md) §4 completed 2026-05-19.
...
- **2026-05-18 (ECI registry naming ratification):** Neutral section updated to reflect the 2026-05-18 ECI atomization sprint kickoff per [`_decisions/2026-05-18_eci_registry_naming.md`](../_decisions/2026-05-18_eci_registry_naming.md). Package name `@empressaio/atom-internal` confirmed as canonical; dedicated repo `empressaioemail-tech/empressa-atom-internal` decided. Sprint plan at [`60a_eci_atomization_sprint.md`](../60a_eci_atomization_sprint.md). `related` field gains `60a_eci_atomization_sprint`. The "is unchanged by this ADR" framing in Neutral section flipped to ratification pointer; no Decision-section content changed.
